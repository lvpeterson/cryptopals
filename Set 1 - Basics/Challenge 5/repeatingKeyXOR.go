...
func main(){
	...
	// Challenge Setup
	challengeString := []byte("Burning 'em, if you ain't quick and nimble I go crazy when I hear a cymbal")
	encryptKey := []byte("ICE")

	// Results
	fmt.Println(hex.EncodeToString(repeatingKeyXOR(challengeString, encryptKey)))
}
